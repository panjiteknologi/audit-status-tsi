...
// assets
import { CheckCircleRounded, RemoveRounded } from '@mui/icons-material';
    ...
    MuiCheckbox: {
      defaultProps: {
        ...
        checkedIcon: (
          ...
          >
            <CheckCircleRounded className="filled" style={{ position: 'absolute' }} />
          </Box>
        ),
        indeterminateIcon: (
          <Box
          ...
          >
            <RemoveRounded className="filled" style={{ position: 'absolute' }} />
          </Box>
        )
      },
      styleOverrides: {
